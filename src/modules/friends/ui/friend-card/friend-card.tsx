    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.buttons}>
                <Button style={styles.firstButton} label={buttonLabel} fontSize={14}/>
                <Button style={styles.secondButton} onPress={()=> setIsModalVisible(true)} label={"Видалити"} fontSize={14} textColor={COLORS.purple}/>
            </View>
        </View>
    )
}