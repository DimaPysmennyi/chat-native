...
function deletePost(post: IPost | undefined){
    if (post){
        ...
        <Modal style={styles.modalContainer} isVisible={isVisible}>
            ...
            <View>
                <TouchableOpacity style={styles.editButton}>
                    ...
                    <Text style={{fontFamily: "GTWalsheimPro-Medium"}}>Редагувати допис</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.deleteButton} onPress={() => deletePost(post)}>
                    <TrashIcon width={20} height={20} fill={COLORS.blue}/>
                    <Text style={{fontFamily: "GTWalsheimPro-Medium"}}>Видалити публікацію</Text>
                </TouchableOpacity>
            </View>
